...
@REM 
@REM CVS IDENTIFIER
@REM 	$Id: //depot/bc/main/devHost/util/time/resultCE.bat#4 $
@REM 	
@REM ****************************************************************************
...
@echo Copying %1\time.lib %LIB%
if exist %1\time.lib xcopy /d %1\time.lib %LIB% > nul 
if exist %1\time4.lib xcopy /d %1\time4.lib %LIB% > nul 
