' TestEngineAPI_05ce.vb : Declares the DLL functions for vb2005ce.
...
Module TestEngine
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function teGetVersion (ByVal versionStr As Byte()) As Integer
    End Function
    <DllImport("TestEngine.dll", EntryPoint:="openTestEngine", _
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function openTestEngine (ByVal transport As Integer, ByVal transportDevice As Byte(), ByVal dataRate As UInteger, ByVal retryTimeOut As Integer, ByVal usbTimeOut As Integer) As UInteger
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function openTestEngineSpiTrans (ByVal trans As Byte(), ByVal multi As Integer) As UInteger
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function bccmdBuildName (ByVal handle As UInteger, ByVal name As Byte(), ByVal max_len As UShort, ByRef length As UShort) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function psMergeFromFile (ByVal handle As UInteger, ByVal filePath As Byte()) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function hciSendAclFile (ByVal handle As UInteger, ByVal connHandle As UShort, ByVal fileName As Byte()) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function hciGetAclFileName (ByVal handle As UInteger, ByVal fileName As Byte(), ByRef length As UInteger) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function hciReadRemoteNameRequest (ByVal handle As UInteger, ByVal lap As UInteger, ByVal uap As Byte, ByVal nap As UShort, ByVal page_scan_repetition_mode As Byte, ByVal page_scan_offset As Byte, ByVal clock_offset As UShort, ByVal r As Byte()) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function teGetAvailableSpiPorts (ByRef maxLen As UShort, ByVal ports As Byte(), ByVal trans As Byte(), ByRef count As UShort) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function teGetFaultDesc (ByVal handle As UInteger, ByVal faultCode As UShort, ByVal desc As Byte()) As Integer
    End Function
    ...
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function refEpWriteCalDataFile (ByVal handle As UInteger, ByVal filePath As Byte()) As Integer
    End Function
    <DllImport("TestEngine.dll", EntryPoint:="refEpLoadCalDataFile", _
    CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.Winapi)> _
    Function refEpLoadCalDataFile (ByVal handle As UInteger, ByVal filePath As Byte()) As Integer
    End Function
