...
#ifndef _SOURCE_CODE_RELEASE
    bool read_slut(const GenericPointer *gp);
#endif
...
#ifndef _SOURCE_CODE_RELEASE
    bool read_unifi_location(ChipHelper &aChipHelper, GenericPointer &gp);
    bool read_slut_unifi(GenericPointer slut_location, bool retry);
#endif
