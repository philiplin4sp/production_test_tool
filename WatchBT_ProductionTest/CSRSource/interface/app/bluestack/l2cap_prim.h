/*!
\author  Copyright (C) Cambridge Consultants Ltd 1998
\author  Copyright (C) CSR plc 2008-10
...
#define L2CA_RES_TABLE \
    ...
    L2CA_RES_TABLE_X(L2CA_RESULT_RAW,                       L2CA_RES_TABLE_DUMMY)                      /*!< Debugging - Raw data */
...
#define L2CA_CONRES_TABLE \
    ...
    L2CA_RES_TABLE_X(L2CA_CONNECT_LOCKSTEP_ERROR,               = L2CA_RESULT_LOCKSTEP_ERROR)
...
/*! \brief Register PSM request
    ...
    In the case where we are operating under the CSR scheduler,
...
/*! \brief Disconnect L2CAP by CID
    ...
    Perform a normal L2CAP shutdown given the unique local CID or context.
    To disconnect by context, set cid = 0
*/
typedef struct
{
