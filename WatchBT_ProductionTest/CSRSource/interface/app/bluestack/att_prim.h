...
typedef enum att_type_tag
{
    ...
    att_type_service,           /* 0 Service */
    att_type_include,           /* 1 Include */
    att_type_declaration,       /* 2 Characteristic declaration */
    att_type_ch_extended,       /* 3 Characteristic Extended Properties */
    att_type_ch_descr,          /* 4 Characteristic User Description */
    att_type_ch_c_config,       /* 5 Client Characteristic Configuration */
    att_type_ch_s_config,       /* 6 Server Characteristic Configuration */
    att_type_ch_format,         /* 7 Characteristic Format */
    att_type_ch_agg,            /* 8 Characteristic Aggregate Format */

    /* UUID16 values */
    att_type_value,             /* 9 Characteristic value */
    att_type_full,              /* a generic attribute */

    att_type_service2,          /* b Secondary service */
    /* UUID128 values */ /* FIXME */
/*    att_type_service128,*/        /* b Service */
    att_type_declaration128,    /* c Characteristic declaration w/ UUID128 */
    att_type_value128,          /* d Characteristic value */
    att_type_full128,           /* e generic attribute */
...
/* \brief Request to establish an ATT bearer between a client and a server. */
typedef struct
{
