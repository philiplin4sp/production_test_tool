...
#define HCI_MAX_HOST_BB_OCF            ((hci_op_code_t) 0x006E)
...
#define HCI_MAX_STATUS_OCF             ((hci_op_code_t) 0x0009)
...
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY ((hci_op_code_t)HCI_ULP | 0x001A)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY ((hci_op_code_t)HCI_ULP | 0x001B)
...
#define HCI_MAX_ULP_OCF                       ((hci_op_code_t)0x0020)
...
#define HCI_EV_ULP_LONG_TERM_KEY_REQUESTED      ((hci_event_code_t)0x05)
...
#define HCI_MAX_HOST_BB_RET_OCF            ((hci_op_code_t) 0x006D)
...
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_PARAM_LEN   ((uint8_t) 18)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_PARAM_LEN   ((uint8_t) 2)
...
#define HCI_EV_ULP_LONG_TERM_KEY_REQUESTED_PARAM_LEN      ((uint8_t)13)
...
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_ARG_LEN   ((uint8_t)  6)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_ARG_LEN  ((uint8_t)  6)
...
#define HCI_EV_MASK_ULP_VALID_LO                 ((hci_event_mask_t)0x0000001F)
...
#define HCI_EV_MASK_ULP_LONG_TERM_KEY_REQUESTED_HI    HCI_EV_MASK_HI(HCI_EV_ULP_LONG_TERM_KEY_REQUESTED)
#define HCI_EV_MASK_ULP_LONG_TERM_KEY_REQUESTED_LO    HCI_EV_MASK_LO(HCI_EV_ULP_LONG_TERM_KEY_REQUESTED)
...
#define HCI_IO_CAP_MAX                          HCI_IO_CAP_KEYBOARD_DISPLAY
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_TEST_MAX_LEN                       ((uint8_t)0x25)
...
#define HCI_ULP_ADVERT_CONNECTABLE_DIRECTED        ((uint8_t)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_CONN_LATENCY_MAX            ((uint16_t)0x01F4)
...
typedef struct
{
    ...
    hci_connection_handle_t  connection_handle;
    uint8_t                  long_term_key[16];
} HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_T;

typedef struct
{
    hci_connection_handle_t  connection_handle;
} HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_RET_T;
...
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    hci_connection_handle_t  connection_handle;
} HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_T;

typedef struct
{
    hci_connection_handle_t  connection_handle;
} HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_RET_T;
...
typedef union
{
    ...
    HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_RET_T ulp_long_term_key_requested_reply_args;
    HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_RET_T ulp_long_term_key_requested_negative_reply_args;
...
typedef union hci_uprim_tag
{
    ...
    HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_T hci_ulp_long_term_key_requested_reply;
    HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_T    hci_ulp_long_term_key_requested_negative_reply;
    ...
    HCI_EV_ULP_LONG_TERM_KEY_REQUESTED_T          hci_ulp_long_term_key_requested;
